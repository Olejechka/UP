...
class MainWindow(QMainWindow):
    ...
    def mainscreen(self):
        ...
        self.button1.setGeometry(860, 150, 200, 70)
        self.button1.setStyleSheet(
            'color:' + self.theme_color + ';border: 2px solid ' + self.theme_color + '; background-color: rgba(255,255,255,128);font-size: 20px; border-radius: 15px;')
        self.button1.show()

        self.button2 = QPushButton('Настройки', self)
        self.button2.setGeometry(860, 250, 200, 70)
        ...
        self.button3.setStyleSheet(
            'color:' + self.theme_color + ';border: 2px solid ' + self.theme_color + '; background-color: rgba(255,255,255,128);font-size: 20px; border-radius: 15px;')
        self.button3.setGeometry(860, 350, 200, 70)
    ...
    def settings_screen(self):
        ...
        self.combo_box.setGeometry(860, 100, 200, 30)
        ...
        self.button4.setStyleSheet(
            'color:' + self.theme_color + ';border: 2px solid ' + self.theme_color + '; background-color: rgba(255,255,255,128);font-size: 20px; border-radius: 15px;')
        self.button4.setGeometry(860, 350, 200, 70)
        self.button4.clicked.connect(self.mainscreen)
        self.button4.show()

        self.checkbox = QCheckBox('         Звуки           ', self)
        self.checkbox.setGeometry(860, 20, 200, 30)
