...
class MainWin(QMainWindow):
    ...
    def main_screen(self):
        ...
        self.btnTs1.setStyleSheet("QPushButton { border-radius: 35px; background-color: #e090b5; }")
        self.btnTs1.show()

        self.btnTs2 = QtWidgets.QPushButton('Настройки', self)
        self.btnTs2.setGeometry(150, 250,200, 70)
        self.btnTs2.setStyleSheet("QPushButton { border-radius: 35px; background-color: #e090b5; }")
        ...
        self.btnTs3.setStyleSheet("QPushButton { border-radius: 35px; background-color: #e090b5; }")
    ...
    def second_screen(self):
        ...
        self.btns1.setStyleSheet("QPushButton { border-radius: 35px; background-color: #e090b5; }")
        self.btns1.show()
        ...
        self.btns2.setStyleSheet("QPushButton { border-radius: 35px; background-color: #e090b5; }")
        self.btns2.show()
    ...
    def screen_size(self):
        ...
        self.btnss1.setStyleSheet("QPushButton { border-radius: 35px; background-color: #e090b5; }")
        self.btnss1.show()
        ...
        self.btnss2.setStyleSheet("QPushButton { border-radius: 35px; background-color: #e090b5; }")
        ...
        self.btnss3.setStyleSheet("QPushButton { border-radius: 35px; background-color: #e090b5; }")
